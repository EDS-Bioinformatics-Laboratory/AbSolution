test_that("Ab_palette works for VDJ combinations", {
  ...
  expect_equal(unname(Ab_palette(list_values=list_values,
               ...
               c("#000005", "#11557F", "#035AF5", "#03AAF5", "#FFFA00",
                 "#0600F5", "#06FDF5",  "#06AAF5", "#065AF5", "#0657F5"))
...
test_that("Ab_palette works for VJ combinations", {
  ...
  expect_equal(unname(Ab_palette(list_values=list_values,
                                 ...
                                 type_values="VJ",
                                 colorblind=F)),
               c("#007A00", "#117A7F", "#037AF5", "#037AF5", "#FF7A00",
                 "#067AF5", "#067AF5",  "#067AF5", "#067AF5", "#067AF5"))
...
test_that("Ab_palette works for V (ergo also D or J) gene sets", {
  ...
  expect_equal(unname(Ab_palette(list_values=list_values[["V"]],
                                 ...
                                 type_values="V",
                                 colorblind=F)),
               c("#00008D", "#000084", "#000099", "#00007D", "#FFFFB1"))
...
test_that("Ab_palette works for cuantitative", {
...
test_that("Ab_palette works for cualitative", {
...
test_that("Ab_palette colorblind mode works for V(D)J combinations/cuantitative/cualitative", {
  list_values=c("Group_1","Group_2")
  expect_equal(unname(Ab_palette(list_values=list_values,
                                 vect_genes_comb=NA,
                                 type_values="cualitative",
